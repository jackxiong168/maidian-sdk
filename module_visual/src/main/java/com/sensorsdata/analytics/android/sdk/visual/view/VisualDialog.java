...
public class VisualDialog {
    ...
    public static void showOpenHeatMapDialog(final Activity context, final String featureCode,
        ...
        builder.setTitle(SADisplayUtil.getStringResource(context,
                com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_common_title));
        if (isWifi) {
            builder.setMessage(SADisplayUtil.getStringResource(context,
                    com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_heatmap_wifi_name));
        } else {
            builder.setMessage(SADisplayUtil.getStringResource(context,
                    com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_heatmap_mobile_name));
        }
        builder.setCancelable(false);
        builder.setNegativeButton(SADisplayUtil.getStringResource(context,
                com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_common_cancel),
        ...
        builder.setPositiveButton(SADisplayUtil.getStringResource(context,
                com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_common_continue)
                , new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    public static void showOpenVisualizedAutoTrackDialog(final Activity context,
        ...
        if (isWifi) {
            builder.setMessage(SADisplayUtil.getStringResource(context,
                    com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_visual_wifi_name));
        } else {
            builder.setMessage(SADisplayUtil.getStringResource(context,
                    com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_visual_mobile_name));
        }
        builder.setCancelable(false);
        builder.setNegativeButton(SADisplayUtil.getStringResource(context,
                com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_common_cancel),
    ...
    public static void h5PageTip(final Activity context) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle(SADisplayUtil.getStringResource(context,
                com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_common_title));
        builder.setMessage(SADisplayUtil.getStringResource(context,
